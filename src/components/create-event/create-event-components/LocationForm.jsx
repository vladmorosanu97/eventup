...
export default function LocationForm(props) {
  const { name, hasError, placeholder, isFetchingSearch, locationOptions, suggestionForLocation, location, label } = props;
  return (
        ...
        {location.title !== "" ? (
          <div className="selected-location">
            <div className="ui image label large">
              ...
              {location.title}
              <i className="delete icon" onClick={props.removeSelectedLocation} />
            </div>
          </div>
        ) : (
          ""
